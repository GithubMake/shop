...
<!--        </div>-->
  ...
  <div class="address_bd mt10">
                <h4>新增收货地址</h4>
                <form action="<?php echo \yii\helpers\Url::to(['member/address-edit','id'=>$model->id])?>" name="address_form" method="post">
                    <ul>
                        <li>
                            <label for=""><span>*</span>收 货 人：</label>
                            <input type="text" name="username" class="txt" value="<?php echo $model->username?>"/>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <input type="text" name="detail_address" class="txt address"  value="<?php echo $model->detail_address?>"/>
                        </li>
                        <li>
                            <label for=""><span>*</span>手机号码：</label>
                            <input type="text" name="tel" class="txt" value="<?php echo $model->tel?>"/>
                        </li>
                        <li>
                            <label for="">&nbsp;</label>
                            <input type="checkbox" name="status" class="check" <?php echo (($model->tel)==1)?'ckecked':''?> checked value="<?php echo $model->tel?>"/>设为默认地址
                        </li>
                        <li>
                            <label for="">&nbsp;</label>
