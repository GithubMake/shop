...
<div class="success w990 bc mt15">
    ...
    <div class="success_bd">
        ...
        <p class="message">完成支付后，你可以 <a href="<?php echo \yii\helpers\Url::to(['cart/cart'])?>">查看订单状态</a>  <a href="<?php echo \yii\helpers\Url::to(['goods/goods-category'])?>">继续购物</a> <a href="">问题反馈</a></p>
    </div>
</div>
<!-- 主体部分 end -->
