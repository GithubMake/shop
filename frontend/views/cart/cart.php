...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <?php foreach ($carts as $cart): ?>
            <tr goods-id="<?php echo $cart->goods_id ?>">
                ...
                <td class="col3">
                    ￥<span><?php echo \frontend\models\Cart::getGoodsMarketPrice()[$cart->goods_id] ?></span></td>
                <td class="col4">
                    <a href="javascript:;" class="reduce_num"></a>
                    <input type="text" name="amount" value="<?php echo $cart->amount ?>" class="amount"/>
    ...
    <div class="cart_btn w990 bc mt10">
        <a href="<?php echo \yii\helpers\Url::to(['goods/goods-list'])?>" class="continue">继续购物</a>
        <a href="<?php echo \yii\helpers\Url::to(['cart/cart-order'])?>" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
