 ...
 */
class m180302_023211_create_goods_table extends Migration
{
    /**
     * {@inheritdoc}
     */
...
//market_price	decimal(10,2)	市场价格
            'mark_price'=>$this->decimal(10,2)->notNull()->comment('市场价格'),
...
//is_on_sale	int(1)	是否在售(1在售 0下架)
            'is_on_sale'=>$this->integer(2)->notNull()->comment('是否在售'),
//status	inter(1)	状态(1正常 0回收站)
            'status'=>$this->integer(2)->notNull()->comment('状态'),
//sort	int()	排序
            'sort'=>$this->integer()->notNull()->comment('排序'),
//create_time	int()	添加时间
            'create_time'=>$this->string(15)->notNull()->comment('添加时间'),
//view_times	int()	浏览次数
            'view_times'=>$this->integer()->defaultValue(0)->comment('浏览次数'),
        ]);
    }
